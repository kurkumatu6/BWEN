    ...
    if (in_array($ext, $extensions) && in_array($mim, $types)) {
        ...
        if ($error == 0) {
            if ($size > 3145728) {
                ...
                if (!move_uploaded_file($tmpName, "C:/OSPanel/domains/exK/upload/" .  $newName)) {
...
if(isset($_POST["InsertBtn"])){
    Auto::add($_POST, $newName);
}

include $_SERVER['DOCUMENT_ROOT'] . '/app/admin/views/admin.autos.view.php';